...
def InsertHour(dado):
    con = conexao()
    cur = con.cursor()
    dolarParaReal = dado[0][0] / 100000
    realParaDolar = dado[0][1] / 100000
    euroParaReal =  dado[0][2] / 100000
    realParaEuro =  dado[0][3] / 100000
    euroParaDolar = dado[0][4] / 100000
    dolarParaEuro = dado[0][5] / 100000
